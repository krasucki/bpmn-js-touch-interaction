...
## [0.2.0](https://github.com/krasucki/bpmn-js-touch-interaction/compare/bpmn-js-touch-interaction-v0.1.2...bpmn-js-touch-interaction-v0.2.0) (2026-04-11)


### Features

* initial release (v0.1.0) ([0df2df9](https://github.com/krasucki/bpmn-js-touch-interaction/commit/0df2df9ad94906813baf6fcc9c61a0287213d205))
...
- `examples/index.html` — runnable `Modeler` + `NavigatedViewer` example
  with auto-sync, minimap, zoom controls and live touch-status badge.).
- `npm run example` script — serves repo root on `:8000` via `npx serve`.
...
[Unreleased]: https://github.com/krasucki/bpmn-js-touch-interaction/compare/v0.1.2...HEAD
[0.1.2]: https://github.com/krasucki/bpmn-js-touch-interaction/compare/v0.1.1...v0.1.2
